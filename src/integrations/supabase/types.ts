...
export type Database = {
  ...
  public: {
    ...
    Functions: {
      client_owns_event: {
        Args: { _client_id: string; _event_id: string; _user_id: string }
        Returns: boolean
      }
      get_invitation_guest_by_token: {
        Args: { _guest_token: string }
        Returns: {
          allowed_companions: number
      ...
      link_client_to_auth_user_by_email: {
      ...
      release_event_gift_item_reservation: {
        Args: { _gift_item_id: string; _guest_token: string }
        Returns: {
          created_at: string
          event_id: string
          id: string
